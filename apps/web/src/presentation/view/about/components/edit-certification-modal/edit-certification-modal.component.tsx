...
export function EditCertificationModal({ certification, isOpen, onClose }: Readonly<EditCertificationModalProps>) {
  ...
  function handleDelete() {
    ...
    remove(certification.id, { onSuccess: () => onClose(), onError: (err) => setError(err.message) });
  }
